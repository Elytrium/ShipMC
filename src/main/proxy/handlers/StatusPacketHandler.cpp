...
namespace Ship {
  ...
  inline Errorable<bool> StatusPacketHandler::OnStatusRequest(Connection* connection, const StatusRequest& statusRequest) {
  ...
  inline Errorable<bool> StatusPacketHandler::OnStatusPing(Connection* connection, const StatusPing& statusPing) {
