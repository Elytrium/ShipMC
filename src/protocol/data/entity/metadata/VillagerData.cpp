...
namespace Ship {
  ...
  EnumRegistry<VillagerType> GetVillagerTypeRegistry() {
    ...
    villagerRegistry.RegisterVersion(
      &ProtocolVersion::MINECRAFT_1_19, VersionRegistry(std::vector<VillagerType>({VillagerType::DESERT, VillagerType::JUNGLE, VillagerType::PLAINS,
  ...
  EnumRegistry<VillagerProfession> GetVillagerProfessionRegistry() {
    ...
    professionRegistry.RegisterVersion(&ProtocolVersion::MINECRAFT_1_19,
      VersionRegistry(std::vector<VillagerProfession>({VillagerProfession::NONE, VillagerProfession::ARMORER, VillagerProfession::BUTCHER,
