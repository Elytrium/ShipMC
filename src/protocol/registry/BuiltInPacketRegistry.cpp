...
namespace Ship {
  ...
  PacketRegistry GetPlayRegistry() {
    ...
    clientbound1_17->RegisterPacket(InitializeWorldBorder::PACKET_ORDINAL, 0x20);
    ...
    clientbound1_18->RegisterPacket(SpawnEntity::PACKET_ORDINAL, 0x00);
    clientbound1_18->RegisterPacket(SpawnExperienceOrb::PACKET_ORDINAL, 0x01);
    clientbound1_18->RegisterPacket(SpawnEntity::PACKET_ORDINAL, 0x02);
    clientbound1_18->RegisterPacket(SpawnPainting::PACKET_ORDINAL, 0x03);
    clientbound1_18->RegisterPacket(SpawnPlayer::PACKET_ORDINAL, 0x04);
    //    clientbound1_18->RegisterPacket(SkulkVibration::PACKET_ORDINAL, 0x05); //TODO: SkulkVibration
    clientbound1_18->RegisterPacket(EntityAnimation::PACKET_ORDINAL, 0x06);
    clientbound1_18->RegisterPacket(AwardStatistics::PACKET_ORDINAL, 0x07);
    clientbound1_18->RegisterPacket(AcknowledgeBlockChange::PACKET_ORDINAL, 0x08);
    clientbound1_18->RegisterPacket(BlockDestroyStage::PACKET_ORDINAL, 0x09);
    clientbound1_18->RegisterPacket(BlockEntityData::PACKET_ORDINAL, 0x0A);
    clientbound1_18->RegisterPacket(BlockAction::PACKET_ORDINAL, 0x0B);
    clientbound1_18->RegisterPacket(BlockUpdate::PACKET_ORDINAL, 0x0C);
    clientbound1_18->RegisterPacket(BossBar::PACKET_ORDINAL, 0x0D);
    clientbound1_18->RegisterPacket(ServerChangeDifficulty::PACKET_ORDINAL, 0x0E);
    clientbound1_18->RegisterPacket(LegacyChat::PACKET_ORDINAL, 0x0F);
    clientbound1_18->RegisterPacket(ClearTitle::PACKET_ORDINAL, 0x10);
    clientbound1_18->RegisterPacket(CommandSuggestionResponse::PACKET_ORDINAL, 0x11);
    clientbound1_18->RegisterPacket(DeclareCommands::PACKET_ORDINAL, 0x12);
    clientbound1_18->RegisterPacket(CloseInventory::PACKET_ORDINAL, 0x13);
    clientbound1_18->RegisterPacket(InventoryContent::PACKET_ORDINAL, 0x14);
    clientbound1_18->RegisterPacket(InventoryProperty::PACKET_ORDINAL, 0x15);
    clientbound1_18->RegisterPacket(InventorySlot::PACKET_ORDINAL, 0x16);
    clientbound1_18->RegisterPacket(Cooldown::PACKET_ORDINAL, 0x17);
    clientbound1_18->RegisterPacket(PluginMessage::PACKET_ORDINAL, 0x18);
    clientbound1_18->RegisterPacket(CustomSoundEffect::PACKET_ORDINAL, 0x19);
    clientbound1_18->RegisterPacket(Disconnect::PACKET_ORDINAL, 0x1A);
    clientbound1_18->RegisterPacket(EntityAnimation::PACKET_ORDINAL, 0x1B);
    clientbound1_18->RegisterPacket(Explosion::PACKET_ORDINAL, 0x1C);
    clientbound1_18->RegisterPacket(UnloadChunk::PACKET_ORDINAL, 0x1D);
    clientbound1_18->RegisterPacket(GameEvent::PACKET_ORDINAL, 0x1E);
    clientbound1_18->RegisterPacket(OpenHorseInventory::PACKET_ORDINAL, 0x1F);
    clientbound1_18->RegisterPacket(InitializeWorldBorder::PACKET_ORDINAL, 0x20);
    clientbound1_18->RegisterPacket(KeepAlive::PACKET_ORDINAL, 0x21);
    clientbound1_18->RegisterPacket(ChunkData::PACKET_ORDINAL, 0x22);
    clientbound1_18->RegisterPacket(EntitySoundEffect::PACKET_ORDINAL, 0x23);
    clientbound1_18->RegisterPacket(Particle::PACKET_ORDINAL, 0x24);
    clientbound1_18->RegisterPacket(ChunkLight::PACKET_ORDINAL, 0x25);
    clientbound1_18->RegisterPacket(JoinGame::PACKET_ORDINAL, 0x26);
    clientbound1_18->RegisterPacket(MapData::PACKET_ORDINAL, 0x27);
    clientbound1_18->RegisterPacket(TradeList::PACKET_ORDINAL, 0x28);
    clientbound1_18->RegisterPacket(EntityPosition::PACKET_ORDINAL, 0x29);
    clientbound1_18->RegisterPacket(EntityPositionAndRotation::PACKET_ORDINAL, 0x2A);
    clientbound1_18->RegisterPacket(EntityRotation::PACKET_ORDINAL, 0x2B);
    clientbound1_18->RegisterPacket(MoveVehicle::PACKET_ORDINAL, 0x2C);
    clientbound1_18->RegisterPacket(OpenBook::PACKET_ORDINAL, 0x2D);
    clientbound1_18->RegisterPacket(OpenInventory::PACKET_ORDINAL, 0x2E);
    clientbound1_18->RegisterPacket(OpenSignEditor::PACKET_ORDINAL, 0x2F);
    clientbound1_18->RegisterPacket(Ping::PACKET_ORDINAL, 0x30);
    clientbound1_18->RegisterPacket(CraftRecipeResponse::PACKET_ORDINAL, 0x31);
    clientbound1_18->RegisterPacket(PlayerAbilities::PACKET_ORDINAL, 0x32);
    //    clientbound1_18->RegisterPacket(EndCombatEvent::PACKET_ORDINAL, 0x33); //TODO: EndCombatEvent
    //    clientbound1_18->RegisterPacket(EnterCombatEvent::PACKET_ORDINAL, 0x34); //TODO: EnterCombatEvent
    //    clientbound1_18->RegisterPacket(DeathCombatEvent::PACKET_ORDINAL, 0x35); //TODO: DeathCombatEvent
    clientbound1_18->RegisterPacket(PlayerListItem::PACKET_ORDINAL, 0x36);
    clientbound1_18->RegisterPacket(PlayerFace::PACKET_ORDINAL, 0x37);
    clientbound1_18->RegisterPacket(PositionRotation::PACKET_ORDINAL, 0x38);
    clientbound1_18->RegisterPacket(UnlockRecipes::PACKET_ORDINAL, 0x39);
    clientbound1_18->RegisterPacket(EntityRemove::PACKET_ORDINAL, 0x3A);
    clientbound1_18->RegisterPacket(EntityEffectRemove::PACKET_ORDINAL, 0x3B);
    clientbound1_18->RegisterPacket(ResourcePackRequest::PACKET_ORDINAL, 0x3C);
    clientbound1_18->RegisterPacket(Respawn::PACKET_ORDINAL, 0x3D);
    clientbound1_18->RegisterPacket(EntityLookAt::PACKET_ORDINAL, 0x3E);
    clientbound1_18->RegisterPacket(SectionBlocks::PACKET_ORDINAL, 0x3F);
    clientbound1_18->RegisterPacket(SelectAdvancementsTab::PACKET_ORDINAL, 0x40);
    clientbound1_18->RegisterPacket(ActionBar::PACKET_ORDINAL, 0x41);
    clientbound1_18->RegisterPacket(BorderCenter::PACKET_ORDINAL, 0x42);
    clientbound1_18->RegisterPacket(BorderRadiusSpeed::PACKET_ORDINAL, 0x43);
    clientbound1_18->RegisterPacket(BorderRadius::PACKET_ORDINAL, 0x44);
    clientbound1_18->RegisterPacket(BorderWarningTime::PACKET_ORDINAL, 0x45);
    clientbound1_18->RegisterPacket(BorderWarningRadius::PACKET_ORDINAL, 0x46);
    clientbound1_18->RegisterPacket(Camera::PACKET_ORDINAL, 0x47);
    clientbound1_18->RegisterPacket(HeldSlot::PACKET_ORDINAL, 0x48);
    clientbound1_18->RegisterPacket(ViewPosition::PACKET_ORDINAL, 0x49);
    clientbound1_18->RegisterPacket(ViewDistance::PACKET_ORDINAL, 0x4A);
    clientbound1_18->RegisterPacket(DefaultSpawnPosition::PACKET_ORDINAL, 0x4B);
    clientbound1_18->RegisterPacket(DisplayObjective::PACKET_ORDINAL, 0x4C);
    clientbound1_18->RegisterPacket(EntityMetadata::PACKET_ORDINAL, 0x4D);
    clientbound1_18->RegisterPacket(LeadEntities::PACKET_ORDINAL, 0x4E);
    clientbound1_18->RegisterPacket(EntityVelocity::PACKET_ORDINAL, 0x4F);
    clientbound1_18->RegisterPacket(EntityEquipment::PACKET_ORDINAL, 0x50);
    clientbound1_18->RegisterPacket(Experience::PACKET_ORDINAL, 0x51);
    clientbound1_18->RegisterPacket(Health::PACKET_ORDINAL, 0x52);
    clientbound1_18->RegisterPacket(Objectives::PACKET_ORDINAL, 0x53);
    clientbound1_18->RegisterPacket(Passengers::PACKET_ORDINAL, 0x54);
    clientbound1_18->RegisterPacket(Teams::PACKET_ORDINAL, 0x55);
    clientbound1_18->RegisterPacket(Score::PACKET_ORDINAL, 0x56);
    clientbound1_18->RegisterPacket(SimulationDistance::PACKET_ORDINAL, 0x57);
    clientbound1_18->RegisterPacket(Subtitle::PACKET_ORDINAL, 0x58);
    clientbound1_18->RegisterPacket(WorldTime::PACKET_ORDINAL, 0x59);
    clientbound1_18->RegisterPacket(Title::PACKET_ORDINAL, 0x5A);
    clientbound1_18->RegisterPacket(TitleTimes::PACKET_ORDINAL, 0x5B);
    clientbound1_18->RegisterPacket(EntitySoundEffect::PACKET_ORDINAL, 0x5C);
    clientbound1_18->RegisterPacket(HardcodedSoundEffect::PACKET_ORDINAL, 0x5D);
    clientbound1_18->RegisterPacket(StopSound::PACKET_ORDINAL, 0x5E);
    clientbound1_18->RegisterPacket(TabHeaderFooter::PACKET_ORDINAL, 0x5F);
    clientbound1_18->RegisterPacket(TagQueryResponse::PACKET_ORDINAL, 0x60);
    clientbound1_18->RegisterPacket(PickupItem::PACKET_ORDINAL, 0x61);
    clientbound1_18->RegisterPacket(EntityTeleport::PACKET_ORDINAL, 0x62);
    clientbound1_18->RegisterPacket(Advancements::PACKET_ORDINAL, 0x63);
    clientbound1_18->RegisterPacket(EntityProperties::PACKET_ORDINAL, 0x64);
    clientbound1_18->RegisterPacket(EntityEffect::PACKET_ORDINAL, 0x65);
    clientbound1_18->RegisterPacket(Recipes::PACKET_ORDINAL, 0x66);
    clientbound1_18->RegisterPacket(Tags::PACKET_ORDINAL, 0x67);

    VersionRegistry* clientbound1_19 = clientboundRegistry + ProtocolVersion::MINECRAFT_1_19.GetPacketIDOrdinal();
    clientbound1_19->RegisterPacket(SpawnEntity::PACKET_ORDINAL, 0x00);
    clientbound1_19->RegisterPacket(SpawnExperienceOrb::PACKET_ORDINAL, 0x01);
    clientbound1_19->RegisterPacket(SpawnPlayer::PACKET_ORDINAL, 0x02);
    clientbound1_19->RegisterPacket(EntityAnimation::PACKET_ORDINAL, 0x03);
    clientbound1_19->RegisterPacket(AwardStatistics::PACKET_ORDINAL, 0x04);
    clientbound1_19->RegisterPacket(AcknowledgeBlockChange::PACKET_ORDINAL, 0x05);
    clientbound1_19->RegisterPacket(BlockDestroyStage::PACKET_ORDINAL, 0x06);
    clientbound1_19->RegisterPacket(BlockEntityData::PACKET_ORDINAL, 0x07);
    clientbound1_19->RegisterPacket(BlockAction::PACKET_ORDINAL, 0x08);
    clientbound1_19->RegisterPacket(BlockUpdate::PACKET_ORDINAL, 0x09);
    clientbound1_19->RegisterPacket(BossBar::PACKET_ORDINAL, 0x0A);
    clientbound1_19->RegisterPacket(ServerChangeDifficulty::PACKET_ORDINAL, 0x0B);
    //    clientbound1_19->RegisterPacket(ChatPreview::PACKET_ORDINAL, 0x0C); //TODO: ChatPreview
    clientbound1_19->RegisterPacket(ClearTitle::PACKET_ORDINAL, 0x1D);
    clientbound1_19->RegisterPacket(CommandSuggestionResponse::PACKET_ORDINAL, 0x1E);
    clientbound1_19->RegisterPacket(DeclareCommands::PACKET_ORDINAL, 0x1F);
    clientbound1_19->RegisterPacket(CloseInventory::PACKET_ORDINAL, 0x10);
    clientbound1_19->RegisterPacket(InventoryContent::PACKET_ORDINAL, 0x11);
    clientbound1_19->RegisterPacket(InventoryProperty::PACKET_ORDINAL, 0x12);
    clientbound1_19->RegisterPacket(InventorySlot::PACKET_ORDINAL, 0x13);
    clientbound1_19->RegisterPacket(Cooldown::PACKET_ORDINAL, 0x14);
    clientbound1_19->RegisterPacket(PluginMessage::PACKET_ORDINAL, 0x15);
    clientbound1_19->RegisterPacket(CustomSoundEffect::PACKET_ORDINAL, 0x16);
    clientbound1_19->RegisterPacket(Disconnect::PACKET_ORDINAL, 0x17);
    clientbound1_19->RegisterPacket(EntityAnimation::PACKET_ORDINAL, 0x18);
    clientbound1_19->RegisterPacket(Explosion::PACKET_ORDINAL, 0x19);
    clientbound1_19->RegisterPacket(UnloadChunk::PACKET_ORDINAL, 0x1A);
    clientbound1_19->RegisterPacket(GameEvent::PACKET_ORDINAL, 0x1B);
    clientbound1_19->RegisterPacket(OpenHorseInventory::PACKET_ORDINAL, 0x1C);
    clientbound1_19->RegisterPacket(InitializeWorldBorder::PACKET_ORDINAL, 0x1D);
    clientbound1_19->RegisterPacket(KeepAlive::PACKET_ORDINAL, 0x1E);
    clientbound1_19->RegisterPacket(ChunkData::PACKET_ORDINAL, 0x1F);
    clientbound1_19->RegisterPacket(EntitySoundEffect::PACKET_ORDINAL, 0x20);
    clientbound1_19->RegisterPacket(Particle::PACKET_ORDINAL, 0x21);
    clientbound1_19->RegisterPacket(ChunkLight::PACKET_ORDINAL, 0x22);
    clientbound1_19->RegisterPacket(JoinGame::PACKET_ORDINAL, 0x23);
    clientbound1_19->RegisterPacket(MapData::PACKET_ORDINAL, 0x24);
    clientbound1_19->RegisterPacket(TradeList::PACKET_ORDINAL, 0x25);
    clientbound1_19->RegisterPacket(EntityPosition::PACKET_ORDINAL, 0x26);
    clientbound1_19->RegisterPacket(EntityPositionAndRotation::PACKET_ORDINAL, 0x27);
    clientbound1_19->RegisterPacket(EntityRotation::PACKET_ORDINAL, 0x28);
    clientbound1_19->RegisterPacket(MoveVehicle::PACKET_ORDINAL, 0x29);
    clientbound1_19->RegisterPacket(OpenBook::PACKET_ORDINAL, 0x2A);
    clientbound1_19->RegisterPacket(OpenInventory::PACKET_ORDINAL, 0x2B);
    clientbound1_19->RegisterPacket(OpenSignEditor::PACKET_ORDINAL, 0x2C);
    clientbound1_19->RegisterPacket(Ping::PACKET_ORDINAL, 0x2D);
    clientbound1_19->RegisterPacket(CraftRecipeResponse::PACKET_ORDINAL, 0x2E);
    clientbound1_19->RegisterPacket(PlayerAbilities::PACKET_ORDINAL, 0x2F);
    clientbound1_19->RegisterPacket(LegacyChat::PACKET_ORDINAL, 0x30);
    //    clientbound1_19->RegisterPacket(EndCombatEvent::PACKET_ORDINAL, 0x31); //TODO: EndCombatEvent
    //    clientbound1_19->RegisterPacket(EnterCombatEvent::PACKET_ORDINAL, 0x32); //TODO: EnterCombatEvent
    //    clientbound1_19->RegisterPacket(DeathCombatEvent::PACKET_ORDINAL, 0x33); //TODO: DeathCombatEvent
    clientbound1_19->RegisterPacket(PlayerListItem::PACKET_ORDINAL, 0x34);
    clientbound1_19->RegisterPacket(PlayerFace::PACKET_ORDINAL, 0x35);
    clientbound1_19->RegisterPacket(PositionRotation::PACKET_ORDINAL, 0x36);
    clientbound1_19->RegisterPacket(UnlockRecipes::PACKET_ORDINAL, 0x37);
    clientbound1_19->RegisterPacket(EntityRemove::PACKET_ORDINAL, 0x38);
    clientbound1_19->RegisterPacket(EntityEffectRemove::PACKET_ORDINAL, 0x39);
    clientbound1_19->RegisterPacket(ResourcePackRequest::PACKET_ORDINAL, 0x3A);
    clientbound1_19->RegisterPacket(Respawn::PACKET_ORDINAL, 0x3B);
    clientbound1_19->RegisterPacket(EntityLookAt::PACKET_ORDINAL, 0x3C);
    clientbound1_19->RegisterPacket(SectionBlocks::PACKET_ORDINAL, 0x3D);
    clientbound1_19->RegisterPacket(SelectAdvancementsTab::PACKET_ORDINAL, 0x3E);
    clientbound1_19->RegisterPacket(ServerData::PACKET_ORDINAL, 0x3F);
    clientbound1_19->RegisterPacket(ActionBar::PACKET_ORDINAL, 0x40);
    clientbound1_19->RegisterPacket(BorderCenter::PACKET_ORDINAL, 0x41);
    clientbound1_19->RegisterPacket(BorderRadiusSpeed::PACKET_ORDINAL, 0x42);
    clientbound1_19->RegisterPacket(BorderRadius::PACKET_ORDINAL, 0x43);
    clientbound1_19->RegisterPacket(BorderWarningTime::PACKET_ORDINAL, 0x44);
    clientbound1_19->RegisterPacket(BorderWarningRadius::PACKET_ORDINAL, 0x45);
    clientbound1_19->RegisterPacket(Camera::PACKET_ORDINAL, 0x46);
    clientbound1_19->RegisterPacket(HeldSlot::PACKET_ORDINAL, 0x47);
    clientbound1_19->RegisterPacket(ViewPosition::PACKET_ORDINAL, 0x48);
    clientbound1_19->RegisterPacket(ViewDistance::PACKET_ORDINAL, 0x49);
    clientbound1_19->RegisterPacket(DefaultSpawnPosition::PACKET_ORDINAL, 0x4A);
    clientbound1_19->RegisterPacket(DisplayObjective::PACKET_ORDINAL, 0x4B);
    clientbound1_19->RegisterPacket(EntityMetadata::PACKET_ORDINAL, 0x4C);
    clientbound1_19->RegisterPacket(LeadEntities::PACKET_ORDINAL, 0x4D);
    clientbound1_19->RegisterPacket(EntityVelocity::PACKET_ORDINAL, 0x4E);
    clientbound1_19->RegisterPacket(EntityEquipment::PACKET_ORDINAL, 0x4F);
    clientbound1_19->RegisterPacket(Experience::PACKET_ORDINAL, 0x50);
    clientbound1_19->RegisterPacket(Health::PACKET_ORDINAL, 0x52);
    clientbound1_19->RegisterPacket(Objectives::PACKET_ORDINAL, 0x53);
    clientbound1_19->RegisterPacket(Passengers::PACKET_ORDINAL, 0x54);
    clientbound1_19->RegisterPacket(Teams::PACKET_ORDINAL, 0x55);
    clientbound1_19->RegisterPacket(Score::PACKET_ORDINAL, 0x56);
    clientbound1_19->RegisterPacket(SimulationDistance::PACKET_ORDINAL, 0x57);
    clientbound1_19->RegisterPacket(Subtitle::PACKET_ORDINAL, 0x58);
    clientbound1_19->RegisterPacket(WorldTime::PACKET_ORDINAL, 0x59);
    clientbound1_19->RegisterPacket(Title::PACKET_ORDINAL, 0x5A);
    clientbound1_19->RegisterPacket(TitleTimes::PACKET_ORDINAL, 0x5B);
    clientbound1_19->RegisterPacket(EntitySoundEffect::PACKET_ORDINAL, 0x5C);
    clientbound1_19->RegisterPacket(HardcodedSoundEffect::PACKET_ORDINAL, 0x5D);
    clientbound1_19->RegisterPacket(StopSound::PACKET_ORDINAL, 0x5E);
    clientbound1_19->RegisterPacket(SystemChat::PACKET_ORDINAL, 0x5F);
    clientbound1_19->RegisterPacket(TabHeaderFooter::PACKET_ORDINAL, 0x60);
    clientbound1_19->RegisterPacket(TagQueryResponse::PACKET_ORDINAL, 0x61);
    clientbound1_19->RegisterPacket(PickupItem::PACKET_ORDINAL, 0x62);
    clientbound1_19->RegisterPacket(EntityTeleport::PACKET_ORDINAL, 0x63);
    clientbound1_19->RegisterPacket(Advancements::PACKET_ORDINAL, 0x64);
    clientbound1_19->RegisterPacket(EntityProperties::PACKET_ORDINAL, 0x65);
    clientbound1_19->RegisterPacket(EntityEffect::PACKET_ORDINAL, 0x66);
    clientbound1_19->RegisterPacket(Recipes::PACKET_ORDINAL, 0x67);
    clientbound1_19->RegisterPacket(Tags::PACKET_ORDINAL, 0x68);

    VersionRegistry* clientbound1_19_1 = clientboundRegistry + ProtocolVersion::MINECRAFT_1_19_1.GetPacketIDOrdinal();
    clientbound1_19_1->RegisterPacket(SpawnEntity::PACKET_ORDINAL, 0x00);
    clientbound1_19_1->RegisterPacket(SpawnExperienceOrb::PACKET_ORDINAL, 0x01);
    clientbound1_19_1->RegisterPacket(SpawnPlayer::PACKET_ORDINAL, 0x02);
    clientbound1_19_1->RegisterPacket(EntityAnimation::PACKET_ORDINAL, 0x03);
    clientbound1_19_1->RegisterPacket(AwardStatistics::PACKET_ORDINAL, 0x04);
    clientbound1_19_1->RegisterPacket(AcknowledgeBlockChange::PACKET_ORDINAL, 0x05);
    clientbound1_19_1->RegisterPacket(BlockDestroyStage::PACKET_ORDINAL, 0x06);
    clientbound1_19_1->RegisterPacket(BlockEntityData::PACKET_ORDINAL, 0x07);
    clientbound1_19_1->RegisterPacket(BlockAction::PACKET_ORDINAL, 0x08);
    clientbound1_19_1->RegisterPacket(BlockUpdate::PACKET_ORDINAL, 0x09);
    clientbound1_19_1->RegisterPacket(BossBar::PACKET_ORDINAL, 0x0A);
    clientbound1_19_1->RegisterPacket(ServerChangeDifficulty::PACKET_ORDINAL, 0x0B);
    //    clientbound1_19_1->RegisterPacket(ChatPreview::PACKET_ORDINAL, 0x0C); //TODO: ChatPreview
    clientbound1_19_1->RegisterPacket(ClearTitle::PACKET_ORDINAL, 0x1D);
    clientbound1_19_1->RegisterPacket(CommandSuggestionResponse::PACKET_ORDINAL, 0x1E);
    clientbound1_19_1->RegisterPacket(DeclareCommands::PACKET_ORDINAL, 0x1F);
    clientbound1_19_1->RegisterPacket(CloseInventory::PACKET_ORDINAL, 0x10);
    clientbound1_19_1->RegisterPacket(InventoryContent::PACKET_ORDINAL, 0x11);
    clientbound1_19_1->RegisterPacket(InventoryProperty::PACKET_ORDINAL, 0x12);
    clientbound1_19_1->RegisterPacket(InventorySlot::PACKET_ORDINAL, 0x13);
    clientbound1_19_1->RegisterPacket(Cooldown::PACKET_ORDINAL, 0x14);
    //    clientbound1_19_1->RegisterPacket(ChatSuggestions::PACKET_ORDINAL, 0x15); //TODO: ChatSuggestions
    clientbound1_19_1->RegisterPacket(PluginMessage::PACKET_ORDINAL, 0x16);
    clientbound1_19_1->RegisterPacket(CustomSoundEffect::PACKET_ORDINAL, 0x17);
    //    clientbound1_19_1->RegisterPacket(HideMessage::PACKET_ORDINAL, 0x18); //TODO: HideMessage
    clientbound1_19_1->RegisterPacket(Disconnect::PACKET_ORDINAL, 0x19);
    clientbound1_19_1->RegisterPacket(EntityAnimation::PACKET_ORDINAL, 0x1A);
    clientbound1_19_1->RegisterPacket(Explosion::PACKET_ORDINAL, 0x1B);
    clientbound1_19_1->RegisterPacket(UnloadChunk::PACKET_ORDINAL, 0x1C);
    clientbound1_19_1->RegisterPacket(GameEvent::PACKET_ORDINAL, 0x1D);
    clientbound1_19_1->RegisterPacket(OpenHorseInventory::PACKET_ORDINAL, 0x1E);
    clientbound1_19_1->RegisterPacket(InitializeWorldBorder::PACKET_ORDINAL, 0x1F);
    clientbound1_19_1->RegisterPacket(KeepAlive::PACKET_ORDINAL, 0x20);
    clientbound1_19_1->RegisterPacket(ChunkData::PACKET_ORDINAL, 0x21);
    clientbound1_19_1->RegisterPacket(EntitySoundEffect::PACKET_ORDINAL, 0x22);
    clientbound1_19_1->RegisterPacket(Particle::PACKET_ORDINAL, 0x23);
    clientbound1_19_1->RegisterPacket(ChunkLight::PACKET_ORDINAL, 0x24);
    clientbound1_19_1->RegisterPacket(JoinGame::PACKET_ORDINAL, 0x25);
    clientbound1_19_1->RegisterPacket(MapData::PACKET_ORDINAL, 0x26);
    clientbound1_19_1->RegisterPacket(TradeList::PACKET_ORDINAL, 0x27);
    clientbound1_19_1->RegisterPacket(EntityPosition::PACKET_ORDINAL, 0x28);
    clientbound1_19_1->RegisterPacket(EntityPositionAndRotation::PACKET_ORDINAL, 0x29);
    clientbound1_19_1->RegisterPacket(EntityRotation::PACKET_ORDINAL, 0x2A);
    clientbound1_19_1->RegisterPacket(MoveVehicle::PACKET_ORDINAL, 0x2B);
    clientbound1_19_1->RegisterPacket(OpenBook::PACKET_ORDINAL, 0x2C);
    clientbound1_19_1->RegisterPacket(OpenInventory::PACKET_ORDINAL, 0x2D);
    clientbound1_19_1->RegisterPacket(OpenSignEditor::PACKET_ORDINAL, 0x2E);
    clientbound1_19_1->RegisterPacket(Ping::PACKET_ORDINAL, 0x2F);
    clientbound1_19_1->RegisterPacket(CraftRecipeResponse::PACKET_ORDINAL, 0x30);
    clientbound1_19_1->RegisterPacket(PlayerAbilities::PACKET_ORDINAL, 0x31);
    //    clientbound1_19_1->RegisterPacket(MessageHeader::PACKET_ORDINAL, 0x32); //TODO: MessageHeader
    clientbound1_19_1->RegisterPacket(LegacyChat::PACKET_ORDINAL, 0x33);
    //    clientbound1_19_1->RegisterPacket(EndCombatEvent::PACKET_ORDINAL, 0x34); //TODO: EndCombatEvent
    //    clientbound1_19_1->RegisterPacket(EnterCombatEvent::PACKET_ORDINAL, 0x35); //TODO: EnterCombatEvent
    //    clientbound1_19_1->RegisterPacket(DeathCombatEvent::PACKET_ORDINAL, 0x36); //TODO: DeathCombatEvent
    clientbound1_19_1->RegisterPacket(PlayerListItem::PACKET_ORDINAL, 0x37);
    clientbound1_19_1->RegisterPacket(PlayerFace::PACKET_ORDINAL, 0x38);
    clientbound1_19_1->RegisterPacket(PositionRotation::PACKET_ORDINAL, 0x39);
    clientbound1_19_1->RegisterPacket(UnlockRecipes::PACKET_ORDINAL, 0x3A);
    clientbound1_19_1->RegisterPacket(EntityRemove::PACKET_ORDINAL, 0x3B);
    clientbound1_19_1->RegisterPacket(EntityEffectRemove::PACKET_ORDINAL, 0x3C);
    clientbound1_19_1->RegisterPacket(ResourcePackRequest::PACKET_ORDINAL, 0x3D);
    clientbound1_19_1->RegisterPacket(Respawn::PACKET_ORDINAL, 0x3E);
    clientbound1_19_1->RegisterPacket(EntityLookAt::PACKET_ORDINAL, 0x3F);
    clientbound1_19_1->RegisterPacket(SectionBlocks::PACKET_ORDINAL, 0x40);
    clientbound1_19_1->RegisterPacket(SelectAdvancementsTab::PACKET_ORDINAL, 0x41);
    clientbound1_19_1->RegisterPacket(ServerData::PACKET_ORDINAL, 0x42);
    clientbound1_19_1->RegisterPacket(ActionBar::PACKET_ORDINAL, 0x43);
    clientbound1_19_1->RegisterPacket(BorderCenter::PACKET_ORDINAL, 0x44);
    clientbound1_19_1->RegisterPacket(BorderRadiusSpeed::PACKET_ORDINAL, 0x45);
    clientbound1_19_1->RegisterPacket(BorderRadius::PACKET_ORDINAL, 0x46);
    clientbound1_19_1->RegisterPacket(BorderWarningTime::PACKET_ORDINAL, 0x47);
    clientbound1_19_1->RegisterPacket(BorderWarningRadius::PACKET_ORDINAL, 0x48);
    clientbound1_19_1->RegisterPacket(Camera::PACKET_ORDINAL, 0x49);
    clientbound1_19_1->RegisterPacket(HeldSlot::PACKET_ORDINAL, 0x4A);
    clientbound1_19_1->RegisterPacket(ViewPosition::PACKET_ORDINAL, 0x4B);
    clientbound1_19_1->RegisterPacket(ViewDistance::PACKET_ORDINAL, 0x4C);
    clientbound1_19_1->RegisterPacket(DefaultSpawnPosition::PACKET_ORDINAL, 0x4D);
    //    clientbound1_19_1->RegisterPacket(SetDisplayChatPreview::PACKET_ORDINAL, 0x4E); //TODO: SetDisplayChatPreview
    clientbound1_19_1->RegisterPacket(DisplayObjective::PACKET_ORDINAL, 0x4F);
    clientbound1_19_1->RegisterPacket(EntityMetadata::PACKET_ORDINAL, 0x50);
    clientbound1_19_1->RegisterPacket(LeadEntities::PACKET_ORDINAL, 0x51);
    clientbound1_19_1->RegisterPacket(EntityVelocity::PACKET_ORDINAL, 0x52);
    clientbound1_19_1->RegisterPacket(EntityEquipment::PACKET_ORDINAL, 0x53);
    clientbound1_19_1->RegisterPacket(Experience::PACKET_ORDINAL, 0x54);
    clientbound1_19_1->RegisterPacket(Health::PACKET_ORDINAL, 0x55);
    clientbound1_19_1->RegisterPacket(Objectives::PACKET_ORDINAL, 0x56);
    clientbound1_19_1->RegisterPacket(Passengers::PACKET_ORDINAL, 0x57);
    clientbound1_19_1->RegisterPacket(Teams::PACKET_ORDINAL, 0x58);
    clientbound1_19_1->RegisterPacket(Score::PACKET_ORDINAL, 0x59);
    clientbound1_19_1->RegisterPacket(SimulationDistance::PACKET_ORDINAL, 0x5A);
    clientbound1_19_1->RegisterPacket(Subtitle::PACKET_ORDINAL, 0x5B);
    clientbound1_19_1->RegisterPacket(WorldTime::PACKET_ORDINAL, 0x5C);
    clientbound1_19_1->RegisterPacket(Title::PACKET_ORDINAL, 0x5D);
    clientbound1_19_1->RegisterPacket(TitleTimes::PACKET_ORDINAL, 0x5E);
    clientbound1_19_1->RegisterPacket(EntitySoundEffect::PACKET_ORDINAL, 0x5F);
    clientbound1_19_1->RegisterPacket(HardcodedSoundEffect::PACKET_ORDINAL, 0x60);
    clientbound1_19_1->RegisterPacket(StopSound::PACKET_ORDINAL, 0x61);
    clientbound1_19_1->RegisterPacket(SystemChat::PACKET_ORDINAL, 0x62);
    clientbound1_19_1->RegisterPacket(TabHeaderFooter::PACKET_ORDINAL, 0x63);
    clientbound1_19_1->RegisterPacket(TagQueryResponse::PACKET_ORDINAL, 0x64);
    clientbound1_19_1->RegisterPacket(PickupItem::PACKET_ORDINAL, 0x65);
    clientbound1_19_1->RegisterPacket(EntityTeleport::PACKET_ORDINAL, 0x66);
    clientbound1_19_1->RegisterPacket(Advancements::PACKET_ORDINAL, 0x67);
    clientbound1_19_1->RegisterPacket(EntityProperties::PACKET_ORDINAL, 0x68);
    clientbound1_19_1->RegisterPacket(EntityEffect::PACKET_ORDINAL, 0x69);
    clientbound1_19_1->RegisterPacket(Recipes::PACKET_ORDINAL, 0x6A);
    clientbound1_19_1->RegisterPacket(Tags::PACKET_ORDINAL, 0x6B);
    ...
    serverbound1_18->RegisterPacket(ConfirmTeleport::PACKET_ORDINAL, 0x00);
    serverbound1_18->RegisterPacket(BlockTagQueryRequest::PACKET_ORDINAL, 0x01);
    serverbound1_18->RegisterPacket(ClientChangeDifficulty::PACKET_ORDINAL, 0x02);
    serverbound1_18->RegisterPacket(LegacyChat::PACKET_ORDINAL, 0x03);
    serverbound1_18->RegisterPacket(ClientAction::PACKET_ORDINAL, 0x04);
    serverbound1_18->RegisterPacket(ClientSettings::PACKET_ORDINAL, 0x05);
    serverbound1_18->RegisterPacket(CommandSuggestionRequest::PACKET_ORDINAL, 0x06);
    serverbound1_18->RegisterPacket(ClickInventoryButton::PACKET_ORDINAL, 0x07);
    serverbound1_18->RegisterPacket(ClickSlot::PACKET_ORDINAL, 0x08);
    serverbound1_18->RegisterPacket(CloseInventory::PACKET_ORDINAL, 0x09);
    serverbound1_18->RegisterPacket(PluginMessage::PACKET_ORDINAL, 0x0A);
    serverbound1_18->RegisterPacket(EditBook::PACKET_ORDINAL, 0x0B);
    serverbound1_18->RegisterPacket(TagQueryRequest::PACKET_ORDINAL, 0x0C);
    serverbound1_18->RegisterPacket(EntityInteract::PACKET_ORDINAL, 0x0D);
    serverbound1_18->RegisterPacket(GenerateStructure::PACKET_ORDINAL, 0x0E);
    serverbound1_18->RegisterPacket(KeepAlive::PACKET_ORDINAL, 0x0F); ///
    serverbound1_18->RegisterPacket(LockDifficulty::PACKET_ORDINAL, 0x10);
    serverbound1_18->RegisterPacket(MovePositionOnly::PACKET_ORDINAL, 0x11);
    serverbound1_18->RegisterPacket(Move::PACKET_ORDINAL, 0x12);
    serverbound1_18->RegisterPacket(MoveRotationOnly::PACKET_ORDINAL, 0x13);
    serverbound1_18->RegisterPacket(MoveGroundOnly::PACKET_ORDINAL, 0x14);
    serverbound1_18->RegisterPacket(MoveVehicle::PACKET_ORDINAL, 0x15);
    serverbound1_18->RegisterPacket(BoatPaddle::PACKET_ORDINAL, 0x16);
    serverbound1_18->RegisterPacket(PickItem::PACKET_ORDINAL, 0x17);
    serverbound1_18->RegisterPacket(CraftRecipeRequest::PACKET_ORDINAL, 0x18);
    serverbound1_18->RegisterPacket(PlayerAbilities::PACKET_ORDINAL, 0x19);
    serverbound1_18->RegisterPacket(Digging::PACKET_ORDINAL, 0x1A);
    serverbound1_18->RegisterPacket(EntityAction::PACKET_ORDINAL, 0x1B);
    serverbound1_18->RegisterPacket(PlayerInput::PACKET_ORDINAL, 0x1C);
    serverbound1_18->RegisterPacket(Ping::PACKET_ORDINAL, 0x1D);
    serverbound1_18->RegisterPacket(SeenRecipe::PACKET_ORDINAL, 0x1E);
    serverbound1_18->RegisterPacket(ChangeRecipeBookSettings::PACKET_ORDINAL, 0x1F);
    serverbound1_18->RegisterPacket(RenameItem::PACKET_ORDINAL, 0x20);
    serverbound1_18->RegisterPacket(ResourcePackResponse::PACKET_ORDINAL, 0x21);
    serverbound1_18->RegisterPacket(SelectAdvancementsTab::PACKET_ORDINAL, 0x22);
    serverbound1_18->RegisterPacket(SelectTrade::PACKET_ORDINAL, 0x23);
    serverbound1_18->RegisterPacket(BeaconEffect::PACKET_ORDINAL, 0x24);
    serverbound1_18->RegisterPacket(HeldSlot::PACKET_ORDINAL, 0x25);
    serverbound1_18->RegisterPacket(ProgramCommandBlock::PACKET_ORDINAL, 0x26);
    serverbound1_18->RegisterPacket(ProgramCommandBlockMinecart::PACKET_ORDINAL, 0x27);
    serverbound1_18->RegisterPacket(CreativeSlot::PACKET_ORDINAL, 0x28);
    serverbound1_18->RegisterPacket(ProgramJigsawBlock::PACKET_ORDINAL, 0x29);
    serverbound1_18->RegisterPacket(ProgramStructureBlock::PACKET_ORDINAL, 0x2A);
    serverbound1_18->RegisterPacket(EditSign::PACKET_ORDINAL, 0x2B);
    serverbound1_18->RegisterPacket(SwingArm::PACKET_ORDINAL, 0x2C);
    serverbound1_18->RegisterPacket(Spectate::PACKET_ORDINAL, 0x2D);
    serverbound1_18->RegisterPacket(PlaceBlock::PACKET_ORDINAL, 0x2E);
    serverbound1_18->RegisterPacket(UseItem::PACKET_ORDINAL, 0x2F);

    VersionRegistry* serverbound1_19 = serverboundRegistry + ProtocolVersion::MINECRAFT_1_19.GetPacketIDOrdinal();
    serverbound1_19->RegisterPacket(ConfirmTeleport::PACKET_ORDINAL, 0x00);
    serverbound1_19->RegisterPacket(BlockTagQueryRequest::PACKET_ORDINAL, 0x01);
    serverbound1_19->RegisterPacket(ClientChangeDifficulty::PACKET_ORDINAL, 0x02);
    serverbound1_19->RegisterPacket(Command::PACKET_ORDINAL, 0x03);
    serverbound1_19->RegisterPacket(LegacyChat::PACKET_ORDINAL, 0x04);
    //    serverbound1_19->RegisterPacket(ChatPreview::PACKET_ORDINAL, 0x05); //TODO: ChatPreview
    serverbound1_19->RegisterPacket(ClientAction::PACKET_ORDINAL, 0x06);
    serverbound1_19->RegisterPacket(ClientSettings::PACKET_ORDINAL, 0x07);
    serverbound1_19->RegisterPacket(CommandSuggestionRequest::PACKET_ORDINAL, 0x08);
    serverbound1_19->RegisterPacket(ClickInventoryButton::PACKET_ORDINAL, 0x09);
    serverbound1_19->RegisterPacket(ClickSlot::PACKET_ORDINAL, 0x0A);
    serverbound1_19->RegisterPacket(CloseInventory::PACKET_ORDINAL, 0x0B);
    serverbound1_19->RegisterPacket(PluginMessage::PACKET_ORDINAL, 0x0C);
    serverbound1_19->RegisterPacket(EditBook::PACKET_ORDINAL, 0x0D);
    serverbound1_19->RegisterPacket(TagQueryRequest::PACKET_ORDINAL, 0x0E);
    serverbound1_19->RegisterPacket(EntityInteract::PACKET_ORDINAL, 0x0F);
    serverbound1_19->RegisterPacket(GenerateStructure::PACKET_ORDINAL, 0x10);
    serverbound1_19->RegisterPacket(KeepAlive::PACKET_ORDINAL, 0x11);
    serverbound1_19->RegisterPacket(LockDifficulty::PACKET_ORDINAL, 0x12);
    serverbound1_19->RegisterPacket(MovePositionOnly::PACKET_ORDINAL, 0x13);
    serverbound1_19->RegisterPacket(Move::PACKET_ORDINAL, 0x14);
    serverbound1_19->RegisterPacket(MoveRotationOnly::PACKET_ORDINAL, 0x15);
    serverbound1_19->RegisterPacket(MoveGroundOnly::PACKET_ORDINAL, 0x16);
    serverbound1_19->RegisterPacket(MoveVehicle::PACKET_ORDINAL, 0x17);
    serverbound1_19->RegisterPacket(BoatPaddle::PACKET_ORDINAL, 0x18);
    serverbound1_19->RegisterPacket(PickItem::PACKET_ORDINAL, 0x19);
    serverbound1_19->RegisterPacket(CraftRecipeRequest::PACKET_ORDINAL, 0x1A);
    serverbound1_19->RegisterPacket(PlayerAbilities::PACKET_ORDINAL, 0x1B);
    serverbound1_19->RegisterPacket(Digging::PACKET_ORDINAL, 0x1C);
    serverbound1_19->RegisterPacket(EntityAction::PACKET_ORDINAL, 0x1D);
    serverbound1_19->RegisterPacket(PlayerInput::PACKET_ORDINAL, 0x1E);
    serverbound1_19->RegisterPacket(Ping::PACKET_ORDINAL, 0x1F);
    serverbound1_19->RegisterPacket(SeenRecipe::PACKET_ORDINAL, 0x20);
    serverbound1_19->RegisterPacket(ChangeRecipeBookSettings::PACKET_ORDINAL, 0x21);
    serverbound1_19->RegisterPacket(RenameItem::PACKET_ORDINAL, 0x22);
    serverbound1_19->RegisterPacket(ResourcePackResponse::PACKET_ORDINAL, 0x23);
    serverbound1_19->RegisterPacket(SelectAdvancementsTab::PACKET_ORDINAL, 0x24);
    serverbound1_19->RegisterPacket(SelectTrade::PACKET_ORDINAL, 0x25);
    serverbound1_19->RegisterPacket(BeaconEffect::PACKET_ORDINAL, 0x26);
    serverbound1_19->RegisterPacket(HeldSlot::PACKET_ORDINAL, 0x27);
    serverbound1_19->RegisterPacket(ProgramCommandBlock::PACKET_ORDINAL, 0x28);
    serverbound1_19->RegisterPacket(ProgramCommandBlockMinecart::PACKET_ORDINAL, 0x29);
    serverbound1_19->RegisterPacket(CreativeSlot::PACKET_ORDINAL, 0x2A);
    serverbound1_19->RegisterPacket(ProgramJigsawBlock::PACKET_ORDINAL, 0x2B);
    serverbound1_19->RegisterPacket(ProgramStructureBlock::PACKET_ORDINAL, 0x2C);
    serverbound1_19->RegisterPacket(EditSign::PACKET_ORDINAL, 0x2D);
    serverbound1_19->RegisterPacket(SwingArm::PACKET_ORDINAL, 0x2E);
    serverbound1_19->RegisterPacket(Spectate::PACKET_ORDINAL, 0x2F);
    serverbound1_19->RegisterPacket(PlaceBlock::PACKET_ORDINAL, 0x30);
    serverbound1_19->RegisterPacket(UseItem::PACKET_ORDINAL, 0x31);

    VersionRegistry* serverbound1_19_1 = serverboundRegistry + ProtocolVersion::MINECRAFT_1_19_1.GetPacketIDOrdinal();
    serverbound1_19_1->RegisterPacket(ConfirmTeleport::PACKET_ORDINAL, 0x00);
    serverbound1_19_1->RegisterPacket(BlockTagQueryRequest::PACKET_ORDINAL, 0x01);
    serverbound1_19_1->RegisterPacket(ClientChangeDifficulty::PACKET_ORDINAL, 0x02);
    //    serverbound1_19_1->RegisterPacket(MessageAcknowledgment::PACKET_ORDINAL, 0x03); //TODO: MessageAcknowledgment
    serverbound1_19_1->RegisterPacket(Command::PACKET_ORDINAL, 0x04);
    serverbound1_19_1->RegisterPacket(LegacyChat::PACKET_ORDINAL, 0x05);
    //    serverbound1_19_1->RegisterPacket(ChatPreview::PACKET_ORDINAL, 0x06); //TODO: ChatPreview
    serverbound1_19_1->RegisterPacket(ClientAction::PACKET_ORDINAL, 0x07);
    serverbound1_19_1->RegisterPacket(ClientSettings::PACKET_ORDINAL, 0x08);
    serverbound1_19_1->RegisterPacket(CommandSuggestionRequest::PACKET_ORDINAL, 0x09);
    serverbound1_19_1->RegisterPacket(ClickInventoryButton::PACKET_ORDINAL, 0x0A);
    serverbound1_19_1->RegisterPacket(ClickSlot::PACKET_ORDINAL, 0x0B);
    serverbound1_19_1->RegisterPacket(CloseInventory::PACKET_ORDINAL, 0x0C);
    serverbound1_19_1->RegisterPacket(PluginMessage::PACKET_ORDINAL, 0x0D);
    serverbound1_19_1->RegisterPacket(EditBook::PACKET_ORDINAL, 0x0E);
    serverbound1_19_1->RegisterPacket(TagQueryRequest::PACKET_ORDINAL, 0x0F);
    serverbound1_19_1->RegisterPacket(EntityInteract::PACKET_ORDINAL, 0x10);
    serverbound1_19_1->RegisterPacket(GenerateStructure::PACKET_ORDINAL, 0x11);
    serverbound1_19_1->RegisterPacket(KeepAlive::PACKET_ORDINAL, 0x12);
    serverbound1_19_1->RegisterPacket(LockDifficulty::PACKET_ORDINAL, 0x13);
    serverbound1_19_1->RegisterPacket(MovePositionOnly::PACKET_ORDINAL, 0x14);
    serverbound1_19_1->RegisterPacket(Move::PACKET_ORDINAL, 0x15);
    serverbound1_19_1->RegisterPacket(MoveRotationOnly::PACKET_ORDINAL, 0x16);
    serverbound1_19_1->RegisterPacket(MoveGroundOnly::PACKET_ORDINAL, 0x17);
    serverbound1_19_1->RegisterPacket(MoveVehicle::PACKET_ORDINAL, 0x18);
    serverbound1_19_1->RegisterPacket(BoatPaddle::PACKET_ORDINAL, 0x19);
    serverbound1_19_1->RegisterPacket(PickItem::PACKET_ORDINAL, 0x1A);
    serverbound1_19_1->RegisterPacket(CraftRecipeRequest::PACKET_ORDINAL, 0x1B);
    serverbound1_19_1->RegisterPacket(PlayerAbilities::PACKET_ORDINAL, 0x1C);
    serverbound1_19_1->RegisterPacket(Digging::PACKET_ORDINAL, 0x1D);
    serverbound1_19_1->RegisterPacket(EntityAction::PACKET_ORDINAL, 0x1E);
    serverbound1_19_1->RegisterPacket(PlayerInput::PACKET_ORDINAL, 0x1F);
    serverbound1_19_1->RegisterPacket(Ping::PACKET_ORDINAL, 0x20);
    serverbound1_19_1->RegisterPacket(SeenRecipe::PACKET_ORDINAL, 0x21);
    serverbound1_19_1->RegisterPacket(ChangeRecipeBookSettings::PACKET_ORDINAL, 0x22);
    serverbound1_19_1->RegisterPacket(RenameItem::PACKET_ORDINAL, 0x23);
    serverbound1_19_1->RegisterPacket(ResourcePackResponse::PACKET_ORDINAL, 0x24);
    serverbound1_19_1->RegisterPacket(SelectAdvancementsTab::PACKET_ORDINAL, 0x25);
    serverbound1_19_1->RegisterPacket(SelectTrade::PACKET_ORDINAL, 0x26);
    serverbound1_19_1->RegisterPacket(BeaconEffect::PACKET_ORDINAL, 0x27);
    serverbound1_19_1->RegisterPacket(HeldSlot::PACKET_ORDINAL, 0x28);
    serverbound1_19_1->RegisterPacket(ProgramCommandBlock::PACKET_ORDINAL, 0x29);
    serverbound1_19_1->RegisterPacket(ProgramCommandBlockMinecart::PACKET_ORDINAL, 0x2A);
    serverbound1_19_1->RegisterPacket(CreativeSlot::PACKET_ORDINAL, 0x2B);
    serverbound1_19_1->RegisterPacket(ProgramJigsawBlock::PACKET_ORDINAL, 0x2C);
    serverbound1_19_1->RegisterPacket(ProgramStructureBlock::PACKET_ORDINAL, 0x2D);
    serverbound1_19_1->RegisterPacket(EditSign::PACKET_ORDINAL, 0x2E);
    serverbound1_19_1->RegisterPacket(SwingArm::PACKET_ORDINAL, 0x2F);
    serverbound1_19_1->RegisterPacket(Spectate::PACKET_ORDINAL, 0x30);
    serverbound1_19_1->RegisterPacket(PlaceBlock::PACKET_ORDINAL, 0x31);
    serverbound1_19_1->RegisterPacket(UseItem::PACKET_ORDINAL, 0x32);
